...
\lstinputlisting[language=c, label=lis1dfast, caption={Problema da Mochila}]{src/knap.cpp}
...
\lstinputlisting[language=c, label=inpoly, caption={Convex Hull.}]{src/graham_scan.cpp}
