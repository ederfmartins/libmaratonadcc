...
\lstinputlisting[language=c, label=maxflow, caption={calcula fluxo máximo, Ford-Fulkerson}]{/home/vod/ederfm/maratona/libmaratonadcc/doc/src/maxFlow.cpp}
\lstinputlisting[language=c, label=maxflowFast, caption={calcula fluxo máximo, algoritmo mais eficiente porém muito maior em tempo de codificação}]{/home/vod/ederfm/maratona/libmaratonadcc/doc/src/maxFlowFast.cpp}
...
\lstinputlisting[language=c, label=nextPermutation, caption={Gera as permutações dos elementos da string}]{/home/vod/ederfm/maratona/libmaratonadcc/doc/src/nextPermutation.cpp}
