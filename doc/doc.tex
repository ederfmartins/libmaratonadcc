...
% TODO: arredondamento, grafos (verificar se grafo é aciclico, componentes conexas, pontos de articulação e pontes), big int, sistemas lineares, fluxo máximo e simplex, polinomios.
